...
public class CreateCollectionsActivity extends BaseActivity implements CollectionsView,View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_createCollections:
                //创建收藏集
                mPresenter.CreateCollections(mEdName.getText().toString(),
